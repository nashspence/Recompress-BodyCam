...
KEEP_ORIGINALS=1 DISABLE_UI=1 zsh shortcuts.sh "$outdir_keep" "$tmpdir/in1.mov" "$tmpdir/in2.mov" || {
...
DISABLE_UI=1 zsh shortcuts.sh "$outdir_del" "$tmpdir/in1.mov" "$tmpdir/in2.mov" || {
